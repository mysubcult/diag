...
<?php
$chat_category = $category; // КАТЕГОРИЯ ($category - это категория, может быть другое значение в зависимости от вашей CMS (движка)
$chat_subcategory = $subcategory; // ПОДкатегория ($subcategory - это подкатегория, может быть другое значение в зависимости от вашей CMS (движка)
?>
<script type="text/javascript">
(function() {
var chat_category = "<?php echo $chat_category ?>";
var chat_subcategory = "<?php echo $chat_subcategory ?>";
var po = document.createElement('script'); po.type = 'text/javascript'; po.async = true;
po.src = 'https://isprof.ru/chat.js?tlgchat_id=psalLIVblFoJtwAkdS04qEAZCcYdFRmX&category='+chat_category+'&subcategory='+chat_subcategory+'';
