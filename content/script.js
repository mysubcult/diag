(function () {
    ...
    text += '<div class="scw-hint hidden" id="scw-hint-greeting" '+posHint+'><div class="scw-hint-content">Р—РґСЂР°РІСЃС‚РІСѓР№С‚Рµ! Р‘СѓРґРµРј СЂР°РґС‹ РІР°Рј РїРѕРјРѕС‡СЊ! </div></div>';
    if (type == 0 || type == 1) {
    ...
    text += '</div>';
    text += '<div class="scw-window" id="scw-window-chat"><div class="scw-window-header"><div class="scw-window-status" id="scw-window-status"></div><div class="scw-button-close" id="scw-button-close">Р—Р°РєСЂС‹С‚СЊ РѕРєРЅРѕ<img src="' + loc + 'img/closerimg.png"></div></div><div class="scw-window-chat" id="scw-window-chat-block"></div><div class="scw-window-input"><form id="scw-input-chat-form"><input type="text" id="scw-input-chat" autocomplete="off" placeholder="Р’РІРµРґРёС‚Рµ СЃРѕРѕР±С‰РµРЅРёРµ"><div class="scw-button-send" id="scw-input-chat-button"><img src="' + loc + 'img/send.png"></div></form></div><div class="scw-window-bottom">Р’РёРґР¶РµС‚ РїСЂРµРґСЃС‚Р°РІР»РµРЅ <a target="_blank" href="http://suitecall.com">SuiteCall.com</a></div></div>';
    text += '<div class="scw-window" id="scw-window-phone"><div class="scw-window-header"><div class="scw-button-close">Р—Р°РєСЂС‹С‚СЊ РѕРєРЅРѕ<img src="' + loc + 'img/closerimg.png"></div></div><div class="scw-window-top-text">РћСЃС‚Р°РІСЊС‚Рµ РІР°С€ РЅРѕРјРµСЂ С‚РµР»РµС„РѕРЅР°.<br> РќР°С€ РјРµРЅРµРґР¶РµСЂ РІР°Рј РїРµСЂРµР·РІРѕРЅРёС‚.</div><div class="scw-window-form"><form id="scw-input-phone-form"><div class="scw-window-input-name"><input type="text" id="scw-input-form-name" placeholder="Р’Р°С€Рµ РёРјСЏ" autocomplete="off"></div><div class="scw-window-input-phone"><div class="scw-window-input-phone-code">+</div><input type="tel" id="scw-input-form-phone" placeholder="Р’Р°С€ РЅРѕРјРµСЂ" autocomplete="off"></div><div class="scw-button-form-phone" id="scw-input-form-button">Р–РґСѓ Р·РІРѕРЅРєР°</div></form></div><div class="scw-window-bottom">Р’РёРґР¶РµС‚ РїСЂРµРґСЃС‚Р°РІР»РµРЅ <a target="_blank" href="http://suitecall.com">SuiteCall.com</a></div></div>';
    div.innerHTML = text;
